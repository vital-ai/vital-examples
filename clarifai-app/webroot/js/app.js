...
var EVENTBUS_URL = window.location.protocol + '//' + window.location.hostname + ':' + window.location.port + '/clarifai-app/eventbus';
...
$(function(){
	...
	vitalservice = new VitalService('endpoint.' + APP_ID, EVENTBUS_URL, function(){
		...
		alert('couldn\'t connect to endpoint -' + err);
	});
...
function uploadNextPart(res) {
	...
	vitalservice.callFunction('Clarifai_ProcessImage', params, function(res){
...
function refreshQuota() {
	...
	vitalservice.callFunction('commons/scripts/Aspen_Usage', {action: 'getUsage',  key: 'clarifai'}, function(res){
